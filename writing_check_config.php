...
/* =========================================================================
 * ภาพรวมเชิงคุณภาพของข้อมูลสะท้อนคิด (reflection_tools.php)
 * สังเคราะห์ปัญหาการเขียน / การตรวจสอบตนเอง / การประเมินเพื่อน / การสะท้อนการเรียนรู้
 * ของทั้งชั้นในหน่วยการเรียนหนึ่ง — ใช้ท่อเดียวกับภาพรวมรายรอบงาน (ai_call_model /
 * ai_extract_json / ai_parse_phase_overview) เพียงเปลี่ยนคำสั่งและข้อมูลที่ป้อนให้เท่านั้น
 * ========================================================================= */

/** ป้ายชื่อ 11 เกณฑ์ของแบบบันทึกปัญหาการเขียน/รายการตรวจสอบตนเอง (ตรงกับ export.php::$CRITERIA) */
function ai_reflection_criteria_labels() {
    return [
...
function ai_reflection_overview_system_prompt() {
    return implode("\n", [
        'คุณคือ "นักวิจัยด้านการสอนภาษาไทย" ที่กำลังอ่านข้อมูลการสะท้อนคิดของนักเรียนทั้งชั้นในหน่วยการเรียนหนึ่ง',
        'ข้อมูลที่ได้รับมี 4 แหล่ง: (1) ปัญหาการเขียนที่นักเรียนบันทึกเองพร้อมแนวทางแก้ไข',
        '(2) ผลประเมินตนเองตามรายการตรวจสอบ 11 เกณฑ์ (3) สิ่งที่เพื่อนประเมินให้และที่นักเรียนประเมินให้เพื่อน',
        '(4) บทสะท้อนการเรียนรู้ 4 ด้าน (โครงสร้างเนื้อหา/กลไกภาษา/การนำข้อเสนอแนะไปใช้/เป้าหมายที่จะพัฒนาต่อ)',
        'หน้าที่ของคุณคือสังเคราะห์ข้อมูลทั้งหมดนี้เป็น "ข้อมูลเชิงคุณภาพ" (qualitative) ให้ครูเห็นภาพว่า',
        'นักเรียนมีปัญหาการเขียนแบบใดร่วมกัน ตรวจสอบตนเองได้ตรงกับความเป็นจริงแค่ไหน และสะท้อนการเรียนรู้อย่างไร',
        '',
        'กติกาสำคัญที่ต้องทำตามอย่างเคร่งครัด:',
        '1. เขียนจากข้อมูลที่ให้มาเท่านั้น ห้ามแต่งตัวเลขหรือเหตุการณ์ที่ไม่มีในข้อมูล',
        '2. เมื่ออ้างจำนวน ให้ใช้คำบอกสัดส่วนอย่าง "ส่วนใหญ่ / ประมาณครึ่งหนึ่ง / ส่วนน้อย"',
        '   หรือใช้ตัวเลขที่ระบบให้มาตรง ๆ ห้ามนับเองแล้วเดาเป็นตัวเลขใหม่',
        '3. ห้ามสรุปว่าผลการวิจัย "มีนัยสำคัญทางสถิติ" หรือระบุค่า p / t เอง — งานนี้เป็นการวิเคราะห์เชิงคุณภาพล้วน ๆ',
        '4. เขียนเป็นภาษาไทยเชิงวิชาการที่อ่านง่าย ตรงไปตรงมา ไม่เยินยอเกินจริง',
        '5. ทุกครั้งที่ระบุ "students" ให้ใช้ค่า "รหัสนักเรียน" ตามที่กำหนดไว้ในข้อมูลแต่ละคนเท่านั้น',
        '   ห้ามสร้างรหัสขึ้นใหม่ ห้ามใส่ชื่อแทนรหัส และห้ามใส่รหัสที่ไม่มีอยู่ในรายการที่ให้มา',
        '6. ข้อ "themes" คือแนวทาง/กลุ่มของปัญหาการเขียนที่พบบ่อยในรอบนี้ ให้จัดนักเรียนที่มีข้อมูลเข้าแนวทางที่ตรงที่สุด',
        '   นักเรียนคนหนึ่งอยู่ได้มากกว่า 1 แนวทางถ้ามีปัญหาหลายด้านจริง ๆ',
        '7. ข้อ "teaching_notes" ให้เขียนเป็น "ย่อหน้าเดียว" (ข้อความยาวต่อเนื่อง ไม่ใช่ลิสต์) ความยาว 4-8 ประโยค',
        '   และใช้เครื่องหมาย ** ครอบคำหรือวลีสำคัญที่ครูควรสังเกตเป็นพิเศษอย่างน้อย 2 จุด',
        '8. ตอบกลับเป็น JSON เพียงอย่างเดียว ห้ามมีข้อความอื่นนอกวงเล็บปีกกา ห้ามใส่ ```',
    ]);
}

/**
 * สร้างคำสั่งสำหรับเขียนภาพรวมเชิงคุณภาพของข้อมูลสะท้อนคิดในหน่วยการเรียนหนึ่ง
 * $stats   = ตัวเลขสรุปที่ระบบคำนวณมาแล้ว (ห้ามให้ระบบคำนวณเอง)
 * $samples = ข้อมูลรายคน [['id','name','problems'=>[...], 'checklist_notes','reflections'=>[...],
 *                          'peer_received'=>[...], 'peer_given'=>[...]], ...]
 */
function ai_build_reflection_overview_prompt($unit, array $stats, array $samples) {
    $critLabels = ai_reflection_criteria_labels();

    $probFreqLine = [];
    foreach (($stats['criteria_problem_freq'] ?? []) as $cid => $n) {
        if ($n > 0) $probFreqLine[] = ($critLabels[$cid] ?? $cid) . ' = ' . $n . ' คน';
    }
    $chkLine = [];
    foreach (($stats['checklist_level_dist'] ?? []) as $cid => $lv) {
        $parts = [];
        foreach ($lv as $level => $n) { if ($n > 0) $parts[] = $level . ' ' . $n . ' คน'; }
        if ($parts) $chkLine[] = ($critLabels[$cid] ?? $cid) . ': ' . implode(', ', $parts);
    }

    $sampleLines = [];
    foreach ($samples as $i => $sp) {
        $lines = [($i + 1) . ') รหัส ' . ($sp['id'] ?? '') . ' (' . ($sp['name'] ?? '') . ')'];
        if (!empty($sp['problems'])) {
            foreach ($sp['problems'] as $p) {
                $lines[] = '   ปัญหา (' . $p['label'] . '): ' . $p['prob'] . ($p['sol'] !== '' ? ' | แนวทางแก้ไข: ' . $p['sol'] : '');
            }
        }
        if (!empty($sp['checklist_notes'])) $lines[] = '   หมายเหตุการตรวจสอบตนเอง: ' . $sp['checklist_notes'];
        if (!empty($sp['reflections'])) {
            foreach ($sp['reflections'] as $rk => $rv) { $lines[] = '   สะท้อนคิด (' . $rk . '): ' . $rv; }
        }
        if (!empty($sp['peer_received'])) {
            foreach ($sp['peer_received'] as $pr) { $lines[] = '   เพื่อนประเมินให้: ' . $pr; }
        }
        if (!empty($sp['peer_given'])) {
            foreach ($sp['peer_given'] as $pg) { $lines[] = '   ประเมินให้เพื่อน: ' . $pg; }
        }
        if (count($lines) > 1) $sampleLines[] = implode("\n", $lines);
    }

    return implode("\n", array_filter([
        'ต่อไปนี้คือข้อมูลการสะท้อนคิดของนักเรียนทั้งชั้นในหน่วยการเรียนหนึ่ง โปรดอ่านแล้ววิเคราะห์เชิงคุณภาพ',
        '',
        '=== ข้อมูลของหน่วยการเรียน ===',
        'หน่วยการเรียน: หน่วยที่ ' . (int)$unit,
        'จำนวนนักเรียนที่มีข้อมูลสะท้อนคิดอย่างน้อยหนึ่งส่วน: ' . (int)($stats['n'] ?? 0) . ' คน',
        'บันทึกปัญหาการเขียนแล้ว: ' . (int)($stats['problems_completed'] ?? 0) . ' คน'
            . ' · ประเมินตนเองแล้ว: ' . (int)($stats['checklists_completed'] ?? 0) . ' คน'
            . ' · เขียนบทสะท้อนคิดแล้ว: ' . (int)($stats['reflections_completed'] ?? 0) . ' คน'
            . ' · มีการประเมินเพื่อนแล้ว: ' . (int)($stats['peer_reviews_count'] ?? 0) . ' รายการ',
        ($probFreqLine ? "จำนวนนักเรียนที่รายงานว่ามีปัญหาในแต่ละเกณฑ์ (เรียงมากไปน้อย):\n- " . implode("\n- ", $probFreqLine) : ''),
        ($chkLine ? "การกระจายผลประเมินตนเองรายเกณฑ์:\n- " . implode("\n- ", $chkLine) : ''),
        '',
        '=== ข้อมูลรายคน (รหัส / ปัญหาและแนวทางแก้ไข / หมายเหตุตรวจสอบตนเอง / บทสะท้อนคิด / การประเมินเพื่อน) ===',
        implode("\n\n", $sampleLines),
        '',
        '=== รูปแบบคำตอบ (ตอบเป็น JSON เท่านั้น) ===',
        '{',
        '  "overview": "ภาพรวม 4-6 ประโยคว่าข้อมูลสะท้อนคิดของทั้งชั้นในหน่วยนี้บอกอะไรบ้าง",',
        '  "themes": [',
        '    { "theme": "ชื่อกลุ่มปัญหาการเขียนที่พบบ่อย สั้น กระชับ",',
        '      "description": "อธิบายกลุ่มปัญหานี้ 1-2 ประโยค",',
        '      "students": ["รหัสนักเรียนทุกคนที่มีปัญหาแบบนี้ ตามรหัสที่กำหนดให้ข้างบนเท่านั้น"] }',
        '  ],',
        '  "interesting": [',
        '    { "text": "สิ่งที่น่าสนใจหรือเหนือความคาดหมายที่พบในข้อมูลชุดนี้",',
        '      "students": ["รหัสนักเรียนที่เป็นตัวอย่างของสิ่งนี้"] }',
        '  ],',
        '  "common_strengths": [',
        '    { "text": "จุดแข็งด้านการตรวจสอบตนเองหรือการสะท้อนการเรียนรู้ที่พบร่วมกัน",',
        '      "students": ["รหัสนักเรียนที่เห็นจุดแข็งนี้ชัดเจน"] }',
        '  ],',
        '  "common_problems": [',
        '    { "text": "ปัญหาการเขียนที่พบซ้ำ ๆ พร้อมบอกว่าน่าจะมาจากอะไร",',
        '      "students": ["รหัสนักเรียนที่พบปัญหานี้"] }',
        '  ],',
        '  "observations": [',
        '    { "text": "ข้อสังเกตเชิงวิจัยที่อ้างอิงข้อมูลที่ให้มาข้างบนเท่านั้น เช่น ความสอดคล้องระหว่างสิ่งที่นักเรียนประเมินตนเองกับสิ่งที่เพื่อนประเมินให้",',
        '      "students": ["รหัสนักเรียนที่เกี่ยวข้อง ถ้ามี — ไม่มีก็ปล่อยเป็นลิสต์ว่าง"] }',
        '  ],',
        '  "teaching_notes": "ย่อหน้าเดียว 4-8 ประโยค บอกสิ่งที่ครูควรทำต่อจากสิ่งที่เห็นในข้อมูลชุดนี้ '
            . 'ใช้ **ตัวเน้น** ครอบคำ/วลีสำคัญอย่างน้อย 2 จุด"',
        '}',
        '',
        'ข้อกำหนด: themes ให้ 3-5 กลุ่ม, interesting 2-4 ข้อ, common_strengths 2-4 ข้อ, common_problems 2-4 ข้อ, observations 2-4 ข้อ,',
        'teaching_notes เป็นสตริงย่อหน้าเดียว ไม่ใช่ลิสต์',
        'ทุกฟิลด์ "students" ต้องใช้เฉพาะรหัสที่ปรากฏในรายการนักเรียนด้านบนเท่านั้น ห้ามสร้างรหัสใหม่หรือใส่ชื่อแทนรหัส',
        'ห้ามระบุค่าทางสถิติหรือสรุปว่า "มีนัยสำคัญ" เอง งานนี้เป็นการวิเคราะห์เชิงคุณภาพเท่านั้น',
    ], function ($v) { return $v !== ''; }));
}

/** แปลงแถวในตาราง reflection_ai_summary ให้เป็นโครงสร้างที่หน้าเว็บใช้ได้ทันที */
function ai_reflection_overview_row(array $row) {
    $dec = function ($v) {
        $d = json_decode((string)$v, true);
        return is_array($d) ? $d : [];
    };
    return [
        'task_unit'        => (int)$row['task_unit'],
        'unit_label'       => 'หน่วยที่ ' . (int)$row['task_unit'],
        'overview'         => (string)$row['overview'],
        'themes'           => $dec($row['themes']),
        'interesting'      => $dec($row['interesting']),
        'common_strengths' => $dec($row['common_strengths']),
