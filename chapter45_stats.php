 ...
 *   5) ความเที่ยงระหว่างผู้ประเมิน : Pearson r และ ICC(3,1)/ICC(3,k) แบบสองทางผสม
...
/**
 * ICC แบบสองทางผสม ความสอดคล้องสัมบูรณ์ (two-way mixed effects, absolute agreement)
 * ใช้โมเดลนี้เพราะผู้ประเมิน (ครูผู้สอน + ผู้เชี่ยวชาญที่เจาะจงไว้) เป็นชุดคนตายตัว
 * ไม่ได้สุ่มมาจากประชากรผู้ประเมินที่กว้างกว่านี้ จึงไม่ต้องการอ้างอิงผลไปยังผู้ประเมินคนอื่น
 * ตามแนวทางการเลือกโมเดลของ Koo & Li (2016) — สูตรคำนวณเหมือนกับ ICC(2,1)/ICC(2,k)
 * (แบบสองทางสุ่ม ความสอดคล้องสัมบูรณ์) ทุกประการ ต่างกันเฉพาะการตั้งชื่อกรณีตามแบบจำลอง
 * $matrix = [[คะแนนผู้ประเมิน 1, ผู้ประเมิน 2, ...], ...] หนึ่งแถวต่อหนึ่งชิ้นงาน
 * คืนทั้ง ICC(3,1) (ผู้ประเมินคนเดียว) และ ICC(3,k) (ค่าเฉลี่ยของผู้ประเมินทั้งหมด)
 */
