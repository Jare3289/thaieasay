          ...
          <div class="row g-3">
            <?php
              $quick = [
                ...
                ['writing_feedback.php',             '✅', 'ระบบตรวจเรียงความอัตโนมัติ', 'ให้ข้อเสนอแนะอัตโนมัติรายคนทุกรอบงาน'],
                ['chapter45.php#research-statistics', '🔬', 'วิเคราะห์งานวิจัย บทที่ 4-5', 'ICC, Paired t-test, เชิงคุณภาพ และเรียบเรียงผลในหน้าเดียว'],
                ...
                ['settings.php',                '⚙️', 'ตั้งค่าระบบ', 'ระบบตรวจอัตโนมัติ ข้อมูลงานวิจัย และ Google'],
              ];
              foreach ($quick as $q):
            ?>
            <div class="col-md-6 col-12">
