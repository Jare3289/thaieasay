 ...
 *
 * ทุกข้อความในไฟล์นี้คำนวณจากข้อมูลจริงในระบบเท่านั้น ไม่ได้เรียกระบบ
...
function report_student_insights(array $sum, array $full) {
    ...
    if ($paired) {
        ...
        $out[] = [
            ...
            'text' => 'ยังไม่มีคู่ไหนที่ระบบตรวจครบทั้งสองฉบับ (ร่างที่ 1 คู่ร่างที่ 2 หรือก่อนเรียนคู่หลังเรียน) '
    ...
    if ($repeat) {
        ...
        if ($items) {
            $out[] = [
                'key' => 'ai_repeat', 'title' => 'ปัญหาที่ระบบชี้ซ้ำหลายรอบ (จุดอ่อนเรื้อรัง)',
