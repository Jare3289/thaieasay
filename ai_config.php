    ...
    if ($hasBase) {
        ...
        if ($isNewTopic) {
            ...
            $baseRules = [
                ...
                '   ให้ขยับคะแนนข้อนั้นขึ้นอย่างน้อย 1 ระดับ ตราบใดที่ยังไม่ถึง 4',
                '4. ข้อที่ก้ำกึ่งระหว่างสองระดับ ให้เลือก "ระดับที่สูงกว่า" เสมอสำหรับร่างที่แก้มาแล้ว',
                '   เพราะความตั้งใจแก้ที่เห็นเป็นรูปธรรมในข้อความถือเป็นหลักฐานของความก้าวหน้า',
...
,
        ...
        ($hasBase && !$isNewTopic
            ? 'ย้ำครั้งสุดท้ายก่อนตอบ: รอบนี้เป็นการตรวจ "ร่างที่นักเรียนแก้มาแล้ว" ให้ไล่เทียบคะแนนทุกข้อ'
              ...
              . 'มาใส่ removed ไม่ได้ ต้องปรับกลับให้เท่าฉบับตั้งต้น และข้อที่นักเรียนแก้ตามที่เคยแนะนำแล้ว'
              . 'ต้องขยับคะแนนขึ้นให้เห็นพัฒนาการ โดยยังต้องมีข้อความจริงจากฉบับนี้ยืนยันเสมอ'
            : null),
        ($hasBase && $isNewTopic
