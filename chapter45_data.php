...
function ch45_meta_fields() {
    return [
        ...
        'defect_cut'    => ['label' => 'เกณฑ์นับว่า "ปรากฏข้อบกพร่อง" — คะแนนดิบต้องน้อยกว่าหรือเท่ากับเท่าใด', 'default' => '2', 'type' => 'number',
                             'hint' => 'คะแนนดิบของแต่ละตัวบ่งชี้เต็ม 4 คะแนน ถ้านักเรียนได้คะแนนดิบ "น้อยกว่าหรือเท่ากับ" ค่านี้ '
                                     . 'จะถูกนับว่า "ปรากฏข้อบกพร่อง" ด้านนั้น เช่น ตั้งไว้ที่ 2 (ค่าเริ่มต้น) '
                                     . 'นักเรียนที่ได้ 0, 1 หรือ 2 คะแนน จะถูกนับว่ามีข้อบกพร่อง ส่วนที่ได้ 3 หรือ 4 คะแนน จะไม่ถูกนับ '
                                     . '— ตั้งค่าสูงขึ้นจะยิ่งนับว่ามีข้อบกพร่องง่ายขึ้น (เกณฑ์หลวมขึ้น)'],
...
function ch45_evidence(array $ds, $indicatorId, array $defects, $perSlot = 3, array $usedW1 = [], array $usedW2 = []) {
    ...
    if (count($w2) < $perSlot && $row['students1']) {
        ...
        // ตัวเลือกสุดท้าย: ผลงานที่ "ทำได้ดี" จึงเรียงจากคะแนนสูงลงมา (คนที่ยังไม่ถูกใช้ที่ไหนมาก่อนเสมอ)
