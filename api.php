...
try {
    switch ($action) {
        ...
        // ให้ระบบช่วยค้นหางานวิจัยที่เกี่ยวข้องจริงจากเว็บ (Gemini + Google Search grounding เท่านั้น)
        // ผลลัพธ์เป็นเพียง "ข้อเสนอ" — ต้องกดยืนยันเพิ่มลงคลังเองเสมอ ไม่มีการบันทึกอัตโนมัติ
